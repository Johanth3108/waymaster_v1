...
get_filename_component(_filename "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui.srv" ""
)

get_filename_component(_filename "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_b.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_b.srv" ""
)

get_filename_component(_filename "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_f.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_f.srv" ""
)

get_filename_component(_filename "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_s.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_s.srv" ""
)
...
_generate_srv_cpp(rgbdslam
  "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rgbdslam
)
_generate_srv_cpp(rgbdslam
  "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_b.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rgbdslam
)
_generate_srv_cpp(rgbdslam
  "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_f.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rgbdslam
)
_generate_srv_cpp(rgbdslam
  "/home/johanth/waymaster_v1/src/rgbdslam_v2/srv/rgbdslam_ros_ui_s.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rgbdslam
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rgbdslam)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rgbdslam\")")
  # install generated code
  install(
