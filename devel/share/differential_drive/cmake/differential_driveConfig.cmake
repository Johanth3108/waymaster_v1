...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/johanth/waymaster_v1/src/differential-drive)
  set(differential_drive_DEVEL_PREFIX /home/johanth/waymaster_v1/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/johanth/waymaster_v1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/johanth/waymaster_v1/src/differential-drive/${idir}'.  ${_report}")
    endif()
